            ...
            <div className='px-20'>
                <div className='grid grid-cols-2 text-end py-3'>
                    ...
                    <div className='flex justify-end gap-2'>
                        ...
                        <Button className="relative ml-2  px-3 text-indigo-900 border-indigo-900 font-extrabold text-lg bg-white isolation-auto z-10 border-2 before:absolute before:w-full before:transition-all before:duration-700 before:hover:w-full before:-right-full before:hover:right-0 rounded-none before:bg-[#FF643A] before:-z-10 before:aspect-square before:hover:scale-150 overflow-hidden before:hover:duration-700 hover:border-[#fff] hover:text-white">
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#522F8F] to-[#D31A65] font-semibold text-base hover:text-white">GET STARTED</span>
                        </Button>
                    </div>
                </div>
