...
const Footer = () => {
  return (
    ...
    <footer className="p-6 dark:bg-gray-100 dark:text-gray-800 bg-[#F1F1FF] md:px-10 px-0">
	<div className="container grid grid-cols-2 mx-auto gap-x-3 gap-y-8 sm:grid-cols-3 md:grid-cols-6 pb-4  px-3">
		
          <div className="col-span-2">
              <img src="https://i.ibb.co/JRHSrS3/new-sitelogo.png" alt="" className="h-10 mx-auto md:mx-0"/>
              <p className="pt-5 text-center md:text-start">EasyDrop, ranked as the top dropshipping platform in Bangladesh, is dedicated to the mission of eradicating unemployment and actively participating in the country's economic growth.</p>
              <ul className="space-y-2 text-[#4b4c6e] pt-5 text-sm md:text-base w-3/4 md:w-full mx-auto">
	...
	<div className="flex items-center justify-center px-2 pt-4 text-sm border-t-2 border-gray-400">
		<span className="text-gray-600 font-bold">Copyright© 2024 EasyDrop. All rights reserved</span>
	</div>
</footer>
  );
};
