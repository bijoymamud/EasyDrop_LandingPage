  ...
  return (
    ...
    <section className="mb-20 pb-20">
         <h1 className="text-4xl font-semibold text-center ">
           ...
           <p className=" text-gray-600 text-lg pt-2 pb-10 w-3/4 mx-auto">Uncover a wide variety of products tailored to meet your needs. Whether you looking for the latest trends, everyday essentials or something special, explore our carefully curated categories to find exactly what you looking for.
